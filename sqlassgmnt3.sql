...
INSERT INTO Emp
(EmployeeID, EmployeeName, Gender, Age, Department, JobRole, Salary, Experience, City, JoiningDate)
VALUES
(101, 'Arun Kumar', 'Male', 28, 'IT', 'Developer', 45000, 3, 'Kochi', '2023-01-15'),
...
SELECT *FROM Emp WHERE Department = 'IT' AND Experience > 3;

SELECT *FROM Emp WHERE City = 'Kochi' OR City = 'Calicut';

SELECT *FROM Emp WHERE Age BETWEEN 25 AND 30;

SELECT *FROM Emp WHERE EmployeeName LIKE 'A%';

SELECT *FROM Emp ORDER BY Salary DESC;

SELECT EmployeeName, Salary AS CurrentSalary,Salary * 12 AS AnnualSalary FROM Emp;

SELECT AVG(Salary) AS AverageSalary FROM Emp;

SELECT Department,AVG(Salary) AS AverageSalary FROM Emp GROUP BY Department HAVING AVG(Salary) > 45000;
